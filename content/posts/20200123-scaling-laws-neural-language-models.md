...
這對投資決策的影響是革命性的。當 OpenAI 去找微軟要十億美元的投資時，他們不再只是說「我們相信更大的模型會更聰明」。他們可以攤開一張圖表，指著那條冪律曲線說：「根據我們的數學模型，用這些資源我們可以訓練一個比 GPT-2 大一百倍的模型，它的表現會提升到這個水準。」這不是信仰，這是工程計算。
...
這篇論文和整個 Scaling Laws 故事後續的人物線——Kaplan 和 Dario Amodei 一起離開 OpenAI 創辦 Anthropic、GPT-3 論文的第一作者 Tom Brown 也加入 Anthropic、OpenAI 內部圍繞 scaling 路線的路線之爭——我們在下一篇會詳細展開。
